...
public class group {
    ...
    public int multiply(int num1, num2){return num1 * num2;} //calculates num1*num2
    public int power(int num1, num2){return num1 * num2;} //calculates num1 to the power of num2
}
